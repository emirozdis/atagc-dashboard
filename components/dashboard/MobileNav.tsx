...
import { LayoutDashboard, Briefcase, ScanLine, User } from "lucide-react";
...
export function MobileNav() {
  ...
  const items = [
    ...
    { href: "/dashboard/committee", icon: Briefcase, label: "Komite" },
    { href: "/dashboard/scan", icon: ScanLine, label: "Yoklama" },
