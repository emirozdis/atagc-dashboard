...
const ROLES = [
  ...
  { 
    ...
    description: "Atandığı komiteyi yönetebilir, yoklama alabilir ve belge düzenleyebilir.",
    icon: ShieldCheck,
  ...
  { 
    id: "staff", 
    label: "Personel (Staff)", 
    description: "Etkinlik personeli. Kısıtlı yönetim haklarına sahiptir.",
    icon: Shield,
  ...
  { 
    id: "staffleader", 
    label: "Personel Lideri", 
    description: "Personel ekibini yönetir.",
    icon: ShieldCheck,
...
export function ManageUserDialog({ 
  ...
  // Reset View State only when completely closed (not just hidden by overlap logic)
  useEffect(() => {
    if (!open) {
      // Delay slightly to allow animation to finish if needed, or immediate
      const t = setTimeout(() => {
        setView("main");
  ...
  return (
    <>
      {/* Main Dialog - Hidden if any confirmation is active */}
      <Dialog 
        ...
        <AlertDialogContent>
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    ...
                    {newRoleObj.id === 'superadmin' && (
                        <div className="mt-3 p-3 bg-red-500/10 text-red-600 rounded-md text-xs font-medium flex items-start gap-2">
                            <AlertTriangle className="w-4 h-4 shrink-0" />
                            Bu kullanıcıya tam sistem erişimi veriyorsunuz.
                        </div>
                    )}
                </AlertDialogDescription>
            </AlertDialogHeader>
            ...
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    {user.is_suspended 
                        ...
                        : "Bu kullanıcı geçici olarak sisteme giriş yapamayacaktır. Verileri silinmez."
                    }
                </AlertDialogDescription>
            </AlertDialogHeader>
            <AlertDialogFooter>
      ...
      <AlertDialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <AlertDialogContent>
            <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                    <strong>{user.full_name}</strong> kullanıcısı ve ilişkili tüm veriler (başvurular, komite kayıtları, yoklamalar) kalıcı olarak silinecektir.
                    <br /><br />
...
// Change Log:
// - Added `staffleader` role to the `ROLES` array to support the "Personel Lideri" role found in other parts of the codebase.