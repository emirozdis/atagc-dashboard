    ...
    <RavenPublicShell>
      <div className="flex items-center justify-center px-5 py-16">
        <section className="raven-public-card w-full max-w-md rounded-3xl p-8 text-center">
          ...
          <h1 className="raven-template-title mt-4 text-2xl font-bold">Passwordless sign-in</h1>
          <p className="mt-3 text-sm leading-6 text-white/75">Passwords are not used by RavenMUN. Sign in with a one-time email code instead.</p>
