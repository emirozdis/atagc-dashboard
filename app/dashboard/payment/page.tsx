        ...
        {!isPaid && (
            <div className="relative group">
                ...
                <div className="relative bg-card border border-border/50 rounded-2xl overflow-hidden shadow-lg">
                    {/* Ticket Header */}
                    <div className="bg-zinc-900 text-white p-4 flex justify-between items-center bg-[url('/noise.png')]">
                        ...
                        <Badge variant="outline" className="border-white/20 text-white bg-white/10">TL</Badge>
                    </div>
                    ...
                    <div className="p-6 md:p-8 space-y-6">
                        <div className="grid gap-6 md:grid-cols-2">
                            <div className="space-y-1.5">
                                ...
                                <div className="font-medium text-lg">ATAGÇ Organizasyon Komitesi</div>
                            </div>
                            <div className="space-y-1.5">
                                <span className="text-[10px] uppercase tracking-widest text-muted-foreground font-bold">Banka</span>
                                <div className="font-medium text-lg">Ziraat Bankası</div>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-3 p-3 bg-amber-500/10 border border-amber-500/20 rounded-lg text-amber-600/90 text-sm">
                            <AlertCircle className="w-5 h-5 shrink-0 mt-0.5" />
                            <p>Lütfen açıklama kısmına <strong>Ad Soyad</strong> yazmayı unutmayınız. Eksik açıklamalı ödemeler onaylanamayabilir.</p>
                        </div>
                    </div>
                </div>
            </div>
