...
export default function ApplicationsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['applications', page, limit, filterStatus, debouncedSearch, sortConfig],
    queryFn: async () => {
...
// Change Log:
// - Fixed "Invalid hook call" error by replacing dynamic `import("react").then(...)` block with standard `useEffect` import and usage.
// - Removed incorrect `useDebounce` comments and artifacts.