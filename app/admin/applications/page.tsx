    ...
    <div className="space-y-6 animate-fade-in pb-12 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col gap-1">
        ...
        <p className="text-muted-foreground text-sm md:text-base">
          Toplam <span className="font-medium text-foreground">{totalRecords}</span> başvuru listeleniyor.
        </p>
      </div>
        ...
        <div className="grid grid-cols-2 sm:flex gap-2">
          ...
          <Select value={filterStatus} onValueChange={(val) => { setFilterStatus(val); setPage(1); }}>
            ...
            <SelectContent>
              ...
              <SelectItem value="unassigned">Atama Bekleyenler</SelectItem>
          ...
          <Select value={sortValue} onValueChange={(val) => { setSortValue(val); setPage(1); }}>
            ...
            <SelectContent>
              ...
              <SelectItem value="school_asc">Okul (A-Z)</SelectItem>
            </SelectContent>
          </Select>
