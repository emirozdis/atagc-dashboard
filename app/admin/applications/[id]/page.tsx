            ...
            <div className="text-sm text-muted-foreground flex-1">
              ...
              {application.review_notes && (
                <p className="mt-1 text-red-500 flex items-center gap-1.5">
                  ...
                  Review Notu: <span className="italic">{application.review_notes}</span>
                </p>
              )}
            </div>
            ...
            {rejectionMode ? (
              ...
              <div className="flex gap-3 w-full md:w-auto">
                {application.status === "pending" ? (
                  <>
                    <Button variant="outline" className="bg-red-600 text-white hover:bg-red-700 flex-1 md:flex-none" onClick={() => setRejectionMode(true)} disabled={actionLoading}>
